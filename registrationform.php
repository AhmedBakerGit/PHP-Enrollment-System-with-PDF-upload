...
<form action="" class="form-horizontal well" method="post" >
	...
	<div class="col-md-4"><label>Academic Year: <?php echo $_SESSION['SY'] ; ?></label></div>
		<table class="table">
			...
			<tr><td><label>Transcript of Records</label></td>
				<td colspan="5"><input required="true" class="form-label" id="TORFILE" name="TORFILE" type="file">
				</tr>

			<tr><td><label>PSA</label></td>
				<td colspan="5"><input required="true" class="form-label" id="TORFILE" name="TORFILE" type="file">
				</tr>

			<tr><td><label>Good Moral Certificate</label></td>
				<td colspan="5"><input required="true" class="form-label" id="TORFILE" name="TORFILE" type="file">
				</tr>
			...
			<td></td>
				<td colspan="5">	
					<button  class="btn btn-success btn-lg" name="transsubmit" justify="center" type="submit">Submit</button>
				</td>
			</tr>
