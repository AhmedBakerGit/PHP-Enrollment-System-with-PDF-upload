...
if($q=='enrol'){   
  if(isset($_SESSION['IDNO'])){ 
    ...
    if ($stud->NewEnrollees == 1) {
      # code...
      // message("You cannot enroll now. For more information, please contact administrator.","error");
              ...
              <div class="well well-sm"  style="background-color:#130da8;color:#fff;"><b >  Login </b> </div>
                  ...
                  <form class="form-horizontal span6" action="login.php" method="POST">
                      <div class="form-group">
                        ...
                        <div class="form-group">
                        <div class="col-md-12"> 
                          <button type="submit" id="oldLogin" name="oldLogin"  style="background-color:#130da8;color:#fff;" class="btn btn-primary btn-sm"><span class="glyphicon glyphicon-logged-in "></span>   Login</button> 
